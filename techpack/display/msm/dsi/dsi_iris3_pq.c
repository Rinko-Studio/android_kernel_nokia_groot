...
void iris_sdr2hdr_level_set(u32 level)
{
	...
	if (level == ICtCpIn_YCbCr) // Add for HLG compatible case
		level = SDR2HDR_Bypass;// Add for HLG compatible case End
