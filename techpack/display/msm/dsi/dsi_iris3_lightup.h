...
#define MDSS_MAX_PANEL_LEN      256
 #define SCH_WORK_CONT_SPLASH // when reboot, if the animation is hanged, use schedule work for cont_splash
...
struct iris_cfg {
	...
	uint32_t add_pt_last_flag;		/* panel on finished packet size */
	uint32_t add_pt_cont_last_flag;	/* cont-splash finished packet size */
	uint32_t split_pkt_size;
	uint32_t add_last_flag_speed_up;
