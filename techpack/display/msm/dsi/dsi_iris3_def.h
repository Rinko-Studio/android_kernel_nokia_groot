...
#define IRIS3_FIRMWARE_NAME_2ND     "2nd_iris3.fw"
#define IRIS3_FIRMWARE_GS_NAME  "iris3_gs.fw"
#define IRIS3_FIRMWARE_OEM_NAME "iris3_oem.fw"
#define IRIS3_FIRMWARE_DEFAULT_NAME  "iris3_default.fw"
#define IRIS3_FIRMWARE_DEFAULT_NAME_2ND  "2nd_iris3_default.fw"
enum {
	IRIS_IP_SYS = 0x00,
	IRIS_IP_RX = 0x01,
	IRIS_IP_TX = 0x02,
