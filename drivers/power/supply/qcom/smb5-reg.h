...
#define JEITA_EN_HOT_AFP_BIT			BIT(7)
#define JEITA_EN_COLD_AFP_BIT			BIT(6)
...
#define USBIN_ASHDN_FAULT_EN_BIT		BIT(3)
#define USBIN_LVUV_FAULT_EN_BIT		BIT(2)

#define DCDC_VBOOST_CFG_REG		(DCDC_BASE + 0x86)
#define VBOOST_5P0V				0x2
#define VBOOST_5P1V				0x3
#define VBOOST_5P2V				0x4
#define VBOOST_VOLTAGE_MASK		GENMASK(2, 0)
